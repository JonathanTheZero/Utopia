...
export function displayCard(card: Emoji, client: Client): unoCard;
export function displayCard(card: Emoji | unoCard, client: Client): Emoji | unoCard {
    if (typeof card === "string") {
        ...
        if (card === "rs") return client.emojis.cache.get("739599287268278272")!;
    ...
    if (card.id === "739599287268278272") return "rs";
